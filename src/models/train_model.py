...
def data_preprocessing():
    ...
    return df, df_train, df_test, X_train, y_train, X_test, y_test

df, df_train, df_test, X_train, y_train, X_test, y_test = data_preprocessing()
...
def main():
    ...
    for name, model in zip(list(models.keys()), list(models.values())):
        with mlflow.start_run():
            ...
            # criacao da pipeline e treinamento dos modelos
            ...
            mlflow.log_param("Scaler Name", 'StandardScaler')
